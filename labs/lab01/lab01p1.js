...
const index_christmas = bob.findIndex(holidays, {name: "Christmas Day"});
const index_canada = bob.findIndex(holidays, {name: "Canada Day"});
console.log("Christmas Day is at index", {index_christmas});
console.log("Canada Day is at index", {index_canada});